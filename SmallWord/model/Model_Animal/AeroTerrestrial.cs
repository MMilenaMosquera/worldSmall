...
{
    internal class AeroTerrestrial : Animal
    {
        public AeroTerrestrial(int id, string species, int age, decimal weigth, ItypeFood diet, int energy, decimal positionX, decimal positionY)
